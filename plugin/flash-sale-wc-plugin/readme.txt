...
Tags: woocommerce, product, wooc, flash sale
...
Add flash sale bar to product bottom

Thêm thanh Flash sale đã bán dưới sản phẩm
...
1. Tải thư mục `flash-sale-product-woocommerce-wpshare247` vào đường dẫn `/wp-content/plugins/`
2. Kích hoạt từ menu **Plugins** (**Plugins > Installed Plugins**).

Tìm **Cấu hình Hover Wooc** hoặc **Product Flash Sale** menu trong WooCommerce.
